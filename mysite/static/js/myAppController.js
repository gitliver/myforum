...
// This controller will get JSON data for the forum threads via the /threads URL
myApp.controller('threadController', function($scope, $http) {
    $http.get("/threads").success(function(response) {$scope.myThreads = response;});
});

// This controller will submit the user-provided data in the Create Thread form
...
myApp.controller('threadFormController', function($scope, $http) {
