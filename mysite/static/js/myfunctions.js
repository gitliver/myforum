...
function ajaxMyForm()
{
    ...
    $('#threadButton').on('click', function(event){
...
function create_post() {
    ...
    $.ajax({
        ...
        data : { 
	    mytitle : $('#id_title').val(),
	    myusername : $('#id_username').val(),
	    mydescription : $('#id_description').val(),
...
// code to thwart Cross Site Request Forgeries (CSRF) attacks via broinjc/WearProtection.js 
